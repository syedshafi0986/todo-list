...
// console.log(init);
  ...
  useEffect(()=>{
   ...
   const ondelete= (tods)=>{
    ...
    // noe that newly created array is passed in settodo function in order to update the application now the array has only 2 elements hence only two elements are shown
